...
import com.inatechno.javabasicapp.databinding.ActivitySpinnerBinding;
...
//TextView txtbuah;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivitySpinnerBinding binding = ActivitySpinnerBinding.inflate(getLayoutInflater());
...
//        spinner = findViewById(R.id.spinnerBuah);
        ...
        binding.spinnerBuah.setAdapter(adapter);
        binding.spinnerBuah.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                binding.imgBuah.setImageResource(gambarBuah[position]);
                binding.txtnamaBuah.setText( getResources().getStringArray(namaBuah)[position]);
